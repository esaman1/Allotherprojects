...
public class HorizontalListView extends AdapterView<ListAdapter> {
    ...
    private DataSetObserver mDataObserver = new C03921();
    ...
    private OnGestureListener mOnGesture = new C03943();
    /* access modifiers changed from: private */
    ...
    class C03921 extends DataSetObserver {
        C03921() {
        }
    ...
    class C03943 extends SimpleOnGestureListener {
        C03943() {
        }
